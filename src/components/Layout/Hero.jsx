      ...
      <div className="w-full mx-auto px-8 md:px-12 max-w-[1220px]">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-[1rem]">
          <div className="lg:max-w-[56%] flex flex-col gap-6">
            <h1 className="text-[2.3rem] md:text-[3.3rem] text-metaBlack md:leading-[78px]">
            ...
            <p className="text-metaBlack text-[16px] md:text-2xl pr-10 md:pr-0 md:max-w-xl font-normal">
              we provide you access to luxury and affordable houses in the
              metaverse, get a chance to turn your imagination to reality at
              your comfort zone
            </p>
            <div className="flex items-center justify-between w-full border-[1px] border-[#B8B8B8] rounded-md max-w-xl overflow-hidden">
              <input type="text" placeholder="Search for location" className="bg-transparent outline-none px-4 placeholder:text-sm placeholder:text-[#B8B8B8]" />
